...
### Tools I've Used
[![My Skills](https://skillicons.dev/icons?i=js,ts,python,java,cs,go,html,css,react,nodejs,fastapi,docker,kubernetes,ansible,azure,aws,mongodb,springboot,sqlite,gitlab,vite,git,mysql,mint,neovim,elasticsearch,bitbucket,figma&theme=dark&perline=7)](https://skillicons.dev)
